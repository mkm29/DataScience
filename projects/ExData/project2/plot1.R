...
p1 <- barplot(height = yearly$TotalEmissions/1000, names.arg = yearly$year, ylab = "Total PM2.5 Emissions in kilotons", main = "PM2.5 Emissions, United States 1999-2008", col = c("green", "blue", "purple", "red"), xlab = "Year", ylim = r)
